...
function guardarInfoDeSegurosInmueblesEnLS(email, TipoDeInmueble, Ubicacion, Mts2, costoM2, cuota) {
...
btnCotizar.addEventListener("click", ()=> {
    ...
    if (resultado !== 'Seleccionar...' && resultado2 !== "" && resultado3 !== 'Seleccionar...') {
        cotizarSeguro()
    }
    else {
        Swal.fire({
